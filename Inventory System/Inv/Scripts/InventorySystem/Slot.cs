...
public class Slot : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private void Start()
    {
        ...
        OnSerializedDataChanged += OnSerializedDataChangedHook;
    }
    ...
    public void SetItem(Item item, int ItemCount)
    {
        ...
        if (_slotImage != null) _slotImage.sprite = item.GetItemSprite(serializedData);
    ...
    private void OnSerializedDataChangedHook(Slot slot, string newSerializedData)
    {
        if (slot != this) return;
